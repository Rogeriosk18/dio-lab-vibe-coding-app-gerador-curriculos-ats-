...
# Contexto
Criar um aplicativo universal que funcione como uma plataforma de matchmaking de vagas de emprego e geração de currículos otimizados para ATS (Applicant Tracking Systems).  
O objetivo é oferecer uma experiência fluida e inclusiva, permitindo que qualquer usuário insira suas informações profissionais e receba recomendações de vagas alinhadas ao seu perfil humano e técnico, além de gerar currículos personalizados e compatíveis com ATS.

# Problema
Muitos candidatos enfrentam dificuldades em encontrar vagas que realmente se alinhem ao seu propósito e cultura, além de terem currículos rejeitados por sistemas ATS.  
O processo atual é burocrático, pouco inclusivo e foca apenas em requisitos técnicos e remuneração, deixando de lado aspectos humanos como impacto social e valores pessoais.

# Público-Alvo
Profissionais de todas as áreas e níveis de experiência que buscam oportunidades de emprego significativas, alinhadas ao seu propósito e que desejam currículos otimizados para ATS.

# Funcionalidades-Chave
1. Inserir informações profissionais: experiência, formação, habilidades, projetos e valores pessoais.  
2. Match automático: recomendações de vagas compatíveis com perfil técnico e humano (propósito, impacto social, alinhamento cultural).  
3. Editor de currículo ATS: sugestões automáticas para adequação e otimização do currículo.  
4. Exportação de currículo: gerar versões em DOCX e PDF.  
5. Interface simples e direta: sem etapas desnecessárias, fluxo inicial sem login ou autenticação.  
6. Design system ShadCN: paleta marrom claro (#D2B48C), branco (#FFFFFF) e cinza (#A9A9A9).  
7. Layout minimalista, responsivo e inclusivo, com foco em clareza e usabilidade.

# Entregável da IA
- Plano de MVP com telas principais (perfil do usuário, vagas sugeridas, editor de currículo, exportação).  
- Recursos necessários: motor de matching, editor ATS, exportação DOCX/PDF.  
